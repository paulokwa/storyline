...
| OpenRouter model selector — default is free model | Needs retest | AI agent | 2026-05-09 | Open Settings with OpenRouter selected. Confirm the model dropdown defaults to Llama 3.1 8B (free), not GPT-4o mini. Requires migration applied. |
| OpenRouter model selector — paid model warning | Needs retest | AI agent | 2026-05-09 | Select GPT-4o mini in the model dropdown. Confirm the amber "Requires OpenRouter credits" note appears. |
