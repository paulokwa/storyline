...
| Story workspace multipurpose right rail | Needs retest | AI agent | 2026-05-01 | Desktop/tablet Story tab now uses one shared right rail for Analyze, AI Partner, Feedback, `Gallery` / `Visual References`, Dictate, and Read Aloud. Browser validation is still needed for panel toggles, left-opening reader dropdown, screenplay/book label behavior, and mobile regression. |
